...
- Keep the combined Team users inventory original-owner-only; return sanitized access metadata and never PINs, access tokens, encrypted access secrets, or their hashes.
