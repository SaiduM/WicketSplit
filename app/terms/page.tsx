...
export default function Terms() {
  return <LegalPage eyebrow="SERVICE TERMS" title="Terms of Use" updated="July 28, 2026">
    ...
    <section><h2>Account security</h2><p>Access is provided through Google authentication. Keep your Google account secure and do not allow unauthorized people to use your signed-in device.</p></section>
