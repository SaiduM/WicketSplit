...
export default function Terms() {
  return <LegalPage eyebrow="SERVICE TERMS" title="Terms of Use" updated="July 28, 2026">
    ...
    <section><h2>Account security</h2><p>Access is provided through Google authentication or a Firebase-managed email account. Keep your password and signed-in devices secure. WicketSplit never receives or stores your Firebase password.</p></section>
