...
function ExpenseModal({expense,leagueFeeExists,players,games,onClose,onSave,onDelete}:{expense?:Expense;leagueFeeExists:boolean;players:Player[];games:Game[];onClose:()=>void;onSave:(e:Omit<Expense,"id">)=>void;onDelete?:()=>void}) {
